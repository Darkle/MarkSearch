...
var electronVersion = require(path.resolve(__dirname, '..', 'package.json')).devDependencies['electron'].slice(1)
...
gulp.task('buildSqlite', () => {
   ...
   * in sqlite3.gyp.
   *
   * Note: the dist-url has changed: https://github.com/electron/electron/releases/tag/v1.4.6 & https://github.com/electron/electron/pull/7881
   */
